...
async function fetchData() {
    try {
        ...
        const request = await fetch('https://3df2-153-150-176-69.ngrok-free.app/yuhoweb', {
            method: "get",
            headers: new Headers({
...
function deleteKeyword(answer) {
    try {
        ...
        fetch(`https://3df2-153-150-176-69.ngrok-free.app/delete/keywords`, {
            method: 'DELETE',
            headers: {
...
function addCustomeSubmit() {
    try {
        ...
        if (finalKeywords[0] && finalAnswer) {
            ...
            fetch('https://3df2-153-150-176-69.ngrok-free.app/add/keywords', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `${accessToken}`
